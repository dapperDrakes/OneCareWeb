    ...
    return (
      <div>
        ...
        <div>
          ...
          />
          <Dropdown value={this.state.dosageMeasure}
                  onChange={this.handleDoseMeasurement}
                  options={[ 'mg', 'mL', 'tablet']} />
      </div>
        <div>
            <h1> Refill Date</h1>
              <Calendar
        ...
        <div>
          ...
          />
          <h3> per </h3>
          <Dropdown value={this.state.scheduleDayWeek}
                  onChange={this.handleScheduleDayWeek}
                  options={[ 'day', 'week']} />
        </div>
        <div>
